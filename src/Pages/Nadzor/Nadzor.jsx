    ...
    <>
      ...
      <P.WrapperOutsourcingOffer>
        <P.LeftContainerOutsourcingOffer>
          <P.LeftContainerHeader>
            Naszym Klientom zapewniamy:
          </P.LeftContainerHeader>
          <P.LeftContainerParagraph>
            Priorytet i bezpieczeństwo powierzonych nam obowiązków, miłą i
            bezproblemową współpracę oraz wywiązywanie się z obowiązków
            pracodawcy ustalonych przez Kodeks Pracy i Państwową Inspekcję
            Pracy, jak i bezpieczeństwo pracowników w Państwa Firmie.
          </P.LeftContainerParagraph>
        </P.LeftContainerOutsourcingOffer>
        <P.RightContainerOutsourcingOffer>
          <P.RightContainerUndorderedList>
            W ramach kompleksowej obsługi w zakresie BHP oferujemy:
            <P.RightContainerList>
              okresowe i wstępne szkolenia BHP,
            </P.RightContainerList>
            <P.RightContainerList>
              przeprowadzanie kontroli warunków pracy oraz przestrzeganie
            ...
            <P.RightContainerList>
              doradztwa w zakresie przepisów oraz zasad bezpieczeństwa i higieny
              pracy,
            </P.RightContainerList>
            <P.RightContainerList>
              doradztwo w zakresie doboru środków ochronny zbiorowej i
              indywidualnej,
            </P.RightContainerList>
            <P.RightContainerList>
            ...
            <P.RightContainerList>
              opracowanie planów modernizacji zakładu pracy zapewniających
              poprawę stanu BHP.
            </P.RightContainerList>
          </P.RightContainerUndorderedList>
        </P.RightContainerOutsourcingOffer>
